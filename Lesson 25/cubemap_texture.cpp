...
//После этого мы попадаем в цикл, который содержит перечисление GL, которое представляет стороны кубической текстуры
...
//Привязываться текстура будет к GL_TEXTURE_CUBE_MAP
